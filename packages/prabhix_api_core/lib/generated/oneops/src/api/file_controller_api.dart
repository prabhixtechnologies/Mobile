...
class FileControllerApi {
  ...
  const FileControllerApi(this._dio);
...
_responseData = rawData == null ? null : rawData as Uint8List;
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FileUploadResponse>> upload({ 
    required MultipartFile file,
    String? purpose = 'MAIL_ATTACHMENT',
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<FileUploadResponse, FileUploadResponse>(rawData, 'FileUploadResponse', growable: true);
