...
class DashboardControllerApi {
  ...
  const DashboardControllerApi(this._dio);
  ...
  Future<Response<DashboardResponse>> get6({ 
...
_responseData = rawData == null ? null : deserialize<DashboardResponse, DashboardResponse>(rawData, 'DashboardResponse', growable: true);
