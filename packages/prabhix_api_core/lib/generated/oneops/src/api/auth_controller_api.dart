...
class AuthControllerApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AckResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AckResponse>> forgotPassword({ 
    ...
    try {
      _bodyData = jsonEncode(emailRequest);
    ...
    AckResponse? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<AckResponse, AckResponse>(rawData, 'AckResponse', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenResponse>> googleSso({ 
    required GoogleSsoRequest googleSsoRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      _bodyData = jsonEncode(googleSsoRequest);
...
_responseData = rawData == null ? null : deserialize<TokenResponse, TokenResponse>(rawData, 'TokenResponse', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthMeResponse>> me1({ 
    required PrabhixPrincipal principal,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<TokenResponse, TokenResponse>(rawData, 'TokenResponse', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [AckResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AckResponse>> requestMagicLink({ 
    required EmailRequest emailRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<AckResponse, AckResponse>(rawData, 'AckResponse', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [AckResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AckResponse>> requestOtp({ 
    required EmailRequest emailRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<AckResponse, AckResponse>(rawData, 'AckResponse', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [AckResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AckResponse>> resetPassword({ 
...
_responseData = rawData == null ? null : deserialize<AckResponse, AckResponse>(rawData, 'AckResponse', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [TokenResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenResponse>> verifyMagicLink({ 
    required MagicLinkVerifyRequest magicLinkVerifyRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      _bodyData = jsonEncode(magicLinkVerifyRequest);
...
_responseData = rawData == null ? null : deserialize<TokenResponse, TokenResponse>(rawData, 'TokenResponse', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [TokenResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenResponse>> verifyOtp({ 
