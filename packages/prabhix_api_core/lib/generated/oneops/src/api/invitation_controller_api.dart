...
class InvitationControllerApi {

  final Dio _dio;

  const InvitationControllerApi(this._dio);
  ...
  Future<Response<Map<String, String>>> accept({ 
    ...
    try {
      _bodyData = jsonEncode(acceptInvitationRequest);
...
_responseData = rawData == null ? null : deserialize<Map<String, String>, String>(rawData, 'Map<String, String>', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Map<String, String>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Map<String, String>>> create8({ 
    ...
    try {
      _bodyData = jsonEncode(createInvitationRequest);
...
_responseData = rawData == null ? null : deserialize<Map<String, String>, String>(rawData, 'Map<String, String>', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PageResponseInvitationView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageResponseInvitationView>> list9({ 
    required PrabhixPrincipal principal,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    PageResponseInvitationView? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<PageResponseInvitationView, PageResponseInvitationView>(rawData, 'PageResponseInvitationView', growable: true);
    ...
    return Response<PageResponseInvitationView>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InvitationPreview>> preview1({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<InvitationPreview, InvitationPreview>(rawData, 'InvitationPreview', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Map<String, String>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Map<String, String>>> resend({ 
    required PrabhixPrincipal principal,
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
