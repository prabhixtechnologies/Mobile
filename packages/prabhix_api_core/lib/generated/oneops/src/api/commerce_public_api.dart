...
class CommercePublicApi {
  ...
  const CommercePublicApi(this._dio);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CartView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CartView>> addPublicCartItem({ 
    ...
    CartView? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<CartView, CartView>(rawData, 'CartView', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CheckoutResponse>> checkoutPublicCart({ 
    required String orgSlug,
    required String cartToken,
...
_responseData = rawData == null ? null : deserialize<CheckoutResponse, CheckoutResponse>(rawData, 'CheckoutResponse', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CreateCartResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateCartResponse>> createPublicCart({ 
    required String orgSlug,
    String? visitorId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    CreateCartResponse? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<CreateCartResponse, CreateCartResponse>(rawData, 'CreateCartResponse', growable: true);
    ...
    return Response<CreateCartResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [CartView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CartView>> getPublicCart({ 
    required String orgSlug,
    required String cartToken,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = rawData == null ? null : deserialize<CartView, CartView>(rawData, 'CartView', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OrderDetail>> getPublicOrder({ 
    required String orgSlug,
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<OrderDetail, OrderDetail>(rawData, 'OrderDetail', growable: true);
...
_responseData = rawData == null ? null : deserialize<ProductDetail, ProductDetail>(rawData, 'ProductDetail', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CursorPageProductSummary>> listPublicProducts({ 
    required String orgSlug,
    String? search,
    String? type,
    String? category,
...
_responseData = rawData == null ? null : deserialize<CursorPageProductSummary, CursorPageProductSummary>(rawData, 'CursorPageProductSummary', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CommerceVerifyPaymentResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CommerceVerifyPaymentResponse>> verifyPublicPayment({ 
    required String orgSlug,
    ...
    CommerceVerifyPaymentResponse? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<CommerceVerifyPaymentResponse, CommerceVerifyPaymentResponse>(rawData, 'CommerceVerifyPaymentResponse', growable: true);
    ...
    return Response<CommerceVerifyPaymentResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
