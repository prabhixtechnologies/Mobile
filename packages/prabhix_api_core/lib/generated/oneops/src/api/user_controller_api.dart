...
class UserControllerApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserProfile>> me({ 
    required PrabhixPrincipal principal,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<UserProfile, UserProfile>(rawData, 'UserProfile', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<DeviceSessionView>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<DeviceSessionView>>> sessions({ 
    required PrabhixPrincipal principal,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    List<DeviceSessionView>? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<List<DeviceSessionView>, DeviceSessionView>(rawData, 'List<DeviceSessionView>', growable: true);
    ...
    return Response<List<DeviceSessionView>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [UserProfile] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserProfile>> updateMe({ 
    required PrabhixPrincipal principal,
...
_responseData = rawData == null ? null : deserialize<UserProfile, UserProfile>(rawData, 'UserProfile', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [UserProfile] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserProfile>> updateNotificationPrefs({ 
    required PrabhixPrincipal principal,
    required NotificationPrefsRequest notificationPrefsRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      _bodyData = jsonEncode(notificationPrefsRequest);
...
_responseData = rawData == null ? null : deserialize<UserProfile, UserProfile>(rawData, 'UserProfile', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [UserProfile] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserProfile>> uploadAvatar({ 
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        if (principal != null) r'principal': principal,
        r'file': file,
      });
