...
class MemberControllerApi {
  ...
  const MemberControllerApi(this._dio);
  ...
  Future<Response<MemberView>> changeRole({ 
    ...
    try {
      _bodyData = jsonEncode(changeMemberRoleRequest);
...
_responseData = rawData == null ? null : deserialize<MemberView, MemberView>(rawData, 'MemberView', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CursorPageMemberView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CursorPageMemberView>> list11({ 
    required String orgId,
    String? cursor,
    int? limit,
    String? search,
    ...
    CursorPageMemberView? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<CursorPageMemberView, CursorPageMemberView>(rawData, 'CursorPageMemberView', growable: true);
    ...
    return Response<CursorPageMemberView>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
