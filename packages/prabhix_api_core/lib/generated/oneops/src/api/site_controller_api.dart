...
class SiteControllerApi {
  ...
  const SiteControllerApi(this._dio);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ApplicationAck] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApplicationAck>> apply({ 
    required JobApplicationRequest application,
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        ...
        if (resume != null) r'resume': resume,
      });
    ...
    ApplicationAck? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ApplicationAck, ApplicationAck>(rawData, 'ApplicationAck', growable: true);
    ...
    return Response<ApplicationAck>(
      data: _responseData,
...
_responseData = rawData == null ? null : deserialize<JobRoleDetail, JobRoleDetail>(rawData, 'JobRoleDetail', growable: true);
  ...
  Future<Response<List<JobRoleSummary>>> careers({ 
    ...
    List<JobRoleSummary>? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<List<JobRoleSummary>, JobRoleSummary>(rawData, 'List<JobRoleSummary>', growable: true);
    ...
    return Response<List<JobRoleSummary>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GenericAck] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericAck>> confirm({ 
    ...
    GenericAck? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<GenericAck, GenericAck>(rawData, 'GenericAck', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [GenericAck] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericAck>> submitLead({ 
    required LeadRequest leadRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      _bodyData = jsonEncode(leadRequest);
...
_responseData = rawData == null ? null : deserialize<GenericAck, GenericAck>(rawData, 'GenericAck', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [GenericAck] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericAck>> subscribe({ 
...
_responseData = rawData == null ? null : deserialize<GenericAck, GenericAck>(rawData, 'GenericAck', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [GenericAck] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericAck>> unsubscribe({ 
    required String token,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
