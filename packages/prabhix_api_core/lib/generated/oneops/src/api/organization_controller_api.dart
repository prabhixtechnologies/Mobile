...
class OrganizationControllerApi {
  ...
  Future<Response<OrganizationView>> create3({ 
    ...
    try {
      _bodyData = jsonEncode(createOrganizationRequest);
...
_responseData = rawData == null ? null : deserialize<OrganizationView, OrganizationView>(rawData, 'OrganizationView', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<OrganizationView>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<OrganizationView>>> list3({ 
    ...
    List<OrganizationView>? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<List<OrganizationView>, OrganizationView>(rawData, 'List<OrganizationView>', growable: true);
    ...
    return Response<List<OrganizationView>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [OrganizationView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OrganizationView>> update2({ 
    required String id,
    ...
    try {
      _bodyData = jsonEncode(updateOrganizationRequest);
