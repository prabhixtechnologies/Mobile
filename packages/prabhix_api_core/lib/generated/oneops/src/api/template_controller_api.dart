...
class TemplateControllerApi {
  ...
  Future<Response<List<TemplateResponse>>> list13({ 
    ...
    List<TemplateResponse>? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<List<TemplateResponse>, TemplateResponse>(rawData, 'List<TemplateResponse>', growable: true);
    ...
    return Response<List<TemplateResponse>>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PreviewResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PreviewResponse>> preview({ 
    required PrabhixPrincipal principal,
    required String key,
    ...
    try {
      _bodyData = jsonEncode(previewRequest);
    ...
    PreviewResponse? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<PreviewResponse, PreviewResponse>(rawData, 'PreviewResponse', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TemplateDetailResponse>> update4({ 
    required PrabhixPrincipal principal,
    required String key,
    ...
    try {
      _bodyData = jsonEncode(updateTemplateRequest);
