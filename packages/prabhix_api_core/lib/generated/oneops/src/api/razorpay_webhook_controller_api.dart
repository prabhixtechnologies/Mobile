...
class RazorpayWebhookControllerApi {

  final Dio _dio;

  const RazorpayWebhookControllerApi(this._dio);
  ...
  Future<Response<void>> handle({ 
    required String body,
    String? xRazorpaySignature,
    String? xRazorpayEventId,
    ...
    final _options = Options(
      ...
      headers: <String, dynamic>{
        ...
        if (xRazorpayEventId != null) r'X-Razorpay-Event-Id': xRazorpayEventId,
        ...?headers,
      },
