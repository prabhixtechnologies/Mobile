...
Native trees are already off `main` and live on `archive/native-*` branches
(see `ARCHIVE.md`). Drop leftover MobiStack HS256 product auth per IDENTITY.md
if any field clients still depend on it.
